...
page.open(options.url, function(status) {
    ...
    page.evaluate(function(fullslider_params) {
        var useragent_tag = getUserAgentTag();
        var slides = decodeURIComponent(
                atob(cleanBase64Params(fullslider_params))
                ).replace(/transform:/g, useragent_tag + "transform:");
        slides = slides.replace(/transform-origin/g, useragent_tag + "transform-origin");
