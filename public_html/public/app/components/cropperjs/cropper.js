...
(function(global, factory) {
        ...
        initContainer: function() {
            ...
            _this.containerData = containerData = {
                width: max(
                        ...
                        Number(vwToPx(options.minContainerWidth)) || 200
                        ),
                height: max(
                        container.offsetHeight,
                        Number(vwToPx(options.minContainerHeight)) || 100
                        )
            };
    ...
    Cropper.DEFAULTS = {
        ...
        minCropBoxWidth: 0,
        minCropBoxHeight: 0,
        minContainerWidth: 42, //vw
        minContainerHeight: 25, //Vw
        // Shortcuts of events
        build: null,
        built: null,
        cropstart: null,
