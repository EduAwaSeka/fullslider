...
var slidethumb = '<div id="slidethumb_^UID^" class="slidethumb thumbelement">'+
				 ...
				 '</div>';
var text_snippet = '<div class="slidelement editable slidelementh1" id="slidelement_id" data-button-class="text" data-parent="impress_slide__slidenumber__" data-type="h2" style="width:auto; height:60px; position:absolute; left:210px; top:50px; whitespace:no-wrap; font-family: \'Montserrat\', sans-serif;"> <div>Sample Text</div> </div>';
