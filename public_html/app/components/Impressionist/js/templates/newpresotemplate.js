...
var slidethumb = '<div id="slidethumb_^UID^" class="slidethumb thumbelement center-block">'+
				 ...
				 '</div>';
var text_snippet = '<div class="slidelement editable" id="slidelement_id" data-button-class="text" data-parent="impress_slide__slidenumber__" data-type="text" style="width:auto; position:absolute; left:210px; top:50px; whitespace:no-wrap; font-family: \'Montserrat\', sans-serif;"> <div>Sample Text</div> </div>';
